...
Describe 'Vanessa service-base admission planning' {
    ...
    It 'uses the <operation> check service generation through creation and subsequent reuse' -TestCases @(
        ...
        Mock Set-ItlDevBranchDatabaseAccessMode { [pscustomobject]@{accessMode='mutation-exclusive'} }
        try {
            ...
            Should -Invoke Set-ItlDevBranchDatabaseAccessMode -Times 1 -Exactly -ParameterFilter { $AccessMode -eq 'mutation-exclusive' -and $State -eq $state }
