Describe "1C workflow dependency lock checks" {
    ...
    It "wires dependency lock mode and verification policy" {
        ...
        $project.aiRules.ref | Should -Be "itl-main-410951e7-r27"
        ...
        $lockTemplate.dependencies.aiRules1c.ref | Should -Be "itl-main-410951e7-r27"
        ...
        $lockTemplate.dependencies.aiRules1c.commit | Should -Be "045d07019efa6678ae47aa8fd28ad280545829d3"
        ...
        $lockTemplate.dependencies.aiRules1c.downstreamRevision | Should -Be 27
