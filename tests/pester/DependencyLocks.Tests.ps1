Describe "1C workflow dependency lock checks" {
    ...
    It "wires dependency lock mode and verification policy" {
        ...
        $project.aiRules.ref | Should -Be "itl-main-410951e7-r29"
        ...
        $lockTemplate.dependencies.aiRules1c.ref | Should -Be "itl-main-410951e7-r29"
        ...
        $lockTemplate.dependencies.aiRules1c.commit | Should -Be "334a5ac6caeececc0a83d214c9f5ba6c98603190"
        ...
        $lockTemplate.dependencies.aiRules1c.downstreamRevision | Should -Be 29
