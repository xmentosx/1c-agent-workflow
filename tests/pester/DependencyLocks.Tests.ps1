Describe "1C workflow dependency lock checks" {
    ...
    It "wires dependency lock mode and verification policy" {
        ...
        $project.aiRules.ref | Should -Be "itl-main-410951e7-r35"
        ...
        $lockTemplate.dependencies.aiRules1c.ref | Should -Be "itl-main-410951e7-r35"
        ...
        $lockTemplate.dependencies.aiRules1c.commit | Should -Be "228dede770213b627159c60de8c04cdbb9930010"
        ...
        $lockTemplate.dependencies.aiRules1c.downstreamRevision | Should -Be 35
        ...
        $lockTemplate.dependencies.itlOndemandMcp.releaseTag | Should -Be "itl-ondemand-mcp-v0.4.11"
        ...
        $lockTemplate.dependencies.vanessaMcp.vaExtension.assetName | Should -Be "VAExtension.1.29-itl-r13.cfe"
        $lockTemplate.dependencies.vanessaMcp.vaExtension.protocol | Should -Be "itl-file-code-v1"
        $lockTemplate.dependencies.vanessaMcp.vaExtension.sha256 | Should -Be "16170f5be0529d0653cfe544e202c925a229de7a27458670b106d1bf2c3cba9f"
        $lockTemplate.dependencies.vanessaAutomation.compatibilityVersion | Should -Be "1.2.043.28"
        $lockTemplate.dependencies.vanessaAutomation.downstreamRevision | Should -Be "itl-r13"
        $lockTemplate.dependencies.vanessaAutomation.sha256 | Should -Be "a96234b5a939734f2345f1e1b010b637c6c94350b8a4debfcae99945dcaf14f5"
        $lockTemplate.dependencies.vanessaAutomation.epfSha256 | Should -Be "16190daa221760630b6d198c5eec794c3c336b38b07599deb289e22a58b43b84"
