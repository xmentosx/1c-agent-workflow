Describe "1C workflow dependency lock checks" {
    ...
    It "wires dependency lock mode and verification policy" {
        ...
        $lockTemplate.dependencies.vanessaAutomation.downstreamRevision | Should -Be "itl-r6"
        $lockTemplate.dependencies.vanessaAutomation.sha256 | Should -Be "4d38ee94a5324b2681eb292d725038b10a544e9c4396b1907fe3dc4c2dccccf8"
        $lockTemplate.dependencies.vanessaAutomation.epfSha256 | Should -Be "bdbfa8cb130b2d8534b46704f5c1ac1c958c63ba5990653a3d0aa05df42f501f"
