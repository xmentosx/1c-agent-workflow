Describe "1C workflow dependency lock checks" {
    ...
    It "wires dependency lock mode and verification policy" {
        ...
        $project.aiRules.ref | Should -Be "itl-main-410951e7-r28"
        ...
        $lockTemplate.dependencies.aiRules1c.ref | Should -Be "itl-main-410951e7-r28"
        ...
        $lockTemplate.dependencies.aiRules1c.commit | Should -Be "431b87a3f43e7b1d6b3ea6f5ae038978c504c879"
        ...
        $lockTemplate.dependencies.aiRules1c.downstreamRevision | Should -Be 28
        ...
        $lockTemplate.dependencies.vanessaAutomation.sha256 | Should -Be "28364081cb02c6d53f674b7c8b111dae1701622935f6c51ddb8cbf29cce1e246"
        $lockTemplate.dependencies.vanessaAutomation.epfSha256 | Should -Be "09c999f88b2ee4a76e7ac2cdd9f1056ba1e1539e8697d24f195810aa4d692e05"
