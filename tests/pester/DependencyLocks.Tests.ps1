Describe "1C workflow dependency lock checks" {
    ...
    It "wires dependency lock mode and verification policy" {
        ...
        $project.aiRules.ref | Should -Be "itl-main-410951e7-r24"
        ...
        $lockTemplate.dependencies.aiRules1c.ref | Should -Be "itl-main-410951e7-r24"
        ...
        $lockTemplate.dependencies.aiRules1c.commit | Should -Be "83e179469363c16497d9cc389a9a814537cc076b"
        ...
        $lockTemplate.dependencies.aiRules1c.downstreamRevision | Should -Be 24
        ...
        $lockTemplate.dependencies.vanessaAutomation.downstreamRevision | Should -Be "itl-r5"
        $lockTemplate.dependencies.vanessaAutomation.sha256 | Should -Be "b2427e90704b7682b2f976524777ea199dbfb0cad695376017cf38dbe447ffd8"
        $lockTemplate.dependencies.vanessaAutomation.epfSha256 | Should -Be "e0f77c9fb48278ca91b16db61db87a887c25b384458b6475c30e260c8fafc75a"
