Describe "1C workflow dependency lock checks" {
    ...
    It "wires dependency lock mode and verification policy" {
        ...
        $project.aiRules.ref | Should -Be "itl-main-410951e7-r23"
        ...
        $lockTemplate.dependencies.aiRules1c.ref | Should -Be "itl-main-410951e7-r23"
        ...
        $lockTemplate.dependencies.aiRules1c.commit | Should -Be "609976be8fefdf1c0168c36ee92f4d985cfd2b09"
        ...
        $lockTemplate.dependencies.aiRules1c.downstreamRevision | Should -Be 23
