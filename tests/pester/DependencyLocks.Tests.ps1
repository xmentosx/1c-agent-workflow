Describe "1C workflow dependency lock checks" {
    ...
    It "wires dependency lock mode and verification policy" {
        ...
        $lockTemplate.dependencies.vanessaAutomation.downstreamRevision | Should -Be "itl-r3"
        $lockTemplate.dependencies.vanessaAutomation.sha256 | Should -Be "e66eb2bec4861ef32f21947b4be8b88df9ca70b254cd7ae6f33406b632201fbf"
        $lockTemplate.dependencies.vanessaAutomation.epfSha256 | Should -Be "74a7542091716b1ceea000367efe8a3cf65582f3c0f1bf5221d1038494a67fca"
