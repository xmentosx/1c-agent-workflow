Describe "1C workflow dependency lock checks" {
    ...
    It "wires dependency lock mode and verification policy" {
        ...
        $lockTemplate.dependencies.vanessaAutomation.downstreamRevision | Should -Be "itl-r2"
        $lockTemplate.dependencies.vanessaAutomation.sha256 | Should -Be "494ecd46bcca4b7c2e420bd49a5be9ed266b8a12b767947d697ecfe555a7f0b8"
        $lockTemplate.dependencies.vanessaAutomation.epfSha256 | Should -Be "671d8caa069000663b9db5157eb4d780eed51b0c81db11ad3fc81b7144960f64"
