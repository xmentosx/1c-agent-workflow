Describe "1C workflow dependency lock checks" {
    ...
    It "wires dependency lock mode and verification policy" {
        ...
        $project.aiRules.ref | Should -Be "itl-main-a421cf44-r6"
        $lockTemplate.dependencies.aiRules1c.repo | Should -Be "https://github.com/xmentosx/itl_ai_rules_1c.git"
        $lockTemplate.dependencies.aiRules1c.ref | Should -Be "itl-main-a421cf44-r6"
        ...
        $lockTemplate.dependencies.aiRules1c.commit | Should -Be "603987af4b4ca2d7c6be9e894edf3b6239f5ed35"
        ...
        $lockTemplate.dependencies.aiRules1c.downstreamRevision | Should -Be 6
