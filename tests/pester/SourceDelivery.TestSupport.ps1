. (Join-Path $PSScriptRoot "TestSupport.ps1")
    ...
    foreach ($name in @("source-delivery-supervisor.ps1", "source-delivery-queue.ps1", "source-delivery-process.ps1", "source-delivery-component.ps1", "source-delivery-plan.ps1", "source-delivery-resources.ps1", "source-delivery-ref-cleanup.ps1", "source-delivery-candidate.ps1", "source-delivery-cleanup.ps1")) {
