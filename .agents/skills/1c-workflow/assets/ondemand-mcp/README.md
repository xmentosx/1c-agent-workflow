...
Update the manifest SHA256 and run the live compatibility Release gate in the same change. Do not admit an upstream version from source inspection or a manually reconstructed schema alone.
