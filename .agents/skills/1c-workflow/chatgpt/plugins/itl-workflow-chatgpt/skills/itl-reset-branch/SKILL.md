---
name: itl-reset-branch
description: "ChatGPT/RDC thin wrapper for the installed project's local itl-reset-branch skill."
---
...
2. Read `<PROJECT_ROOT>\.agents\skills\itl-reset-branch\SKILL.md`; that local file is authoritative.
