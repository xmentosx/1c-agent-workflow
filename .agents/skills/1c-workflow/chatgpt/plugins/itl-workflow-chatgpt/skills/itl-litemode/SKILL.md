---
name: itl-litemode
description: "ChatGPT/RDC thin wrapper for the installed project's local itl-litemode skill."
---
...
2. Read `<PROJECT_ROOT>\.agents\skills\itl-litemode\SKILL.md`; that local file is authoritative.
