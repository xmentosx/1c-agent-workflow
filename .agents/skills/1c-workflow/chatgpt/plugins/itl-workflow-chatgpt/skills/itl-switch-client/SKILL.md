---
name: itl-switch-client
description: "ChatGPT/RDC thin wrapper for the installed project's local itl-switch-client skill."
---
...
2. Read `<PROJECT_ROOT>\.agents\skills\itl-switch-client\SKILL.md`; that local file is authoritative.
