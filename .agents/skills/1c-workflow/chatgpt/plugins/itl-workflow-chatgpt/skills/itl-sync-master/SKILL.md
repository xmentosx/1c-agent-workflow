---
name: itl-sync-master
description: "ChatGPT/RDC thin wrapper for the installed project's local itl-sync-master skill."
---
...
2. Read `<PROJECT_ROOT>\.agents\skills\itl-sync-master\SKILL.md`; that local file is authoritative.
