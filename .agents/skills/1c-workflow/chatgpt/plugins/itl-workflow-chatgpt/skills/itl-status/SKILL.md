---
name: itl-status
description: "ChatGPT/RDC thin wrapper for the installed project's local itl-status skill."
---
...
2. Read `<PROJECT_ROOT>\.agents\skills\itl-status\SKILL.md`; that local file is authoritative.
