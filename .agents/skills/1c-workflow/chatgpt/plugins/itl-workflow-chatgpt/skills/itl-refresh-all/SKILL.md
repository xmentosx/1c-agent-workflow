---
name: itl-refresh-all
description: "ChatGPT/RDC thin wrapper for the installed project's local itl-refresh-all skill."
---
...
2. Read `<PROJECT_ROOT>\.agents\skills\itl-refresh-all\SKILL.md`; that local file is authoritative.
