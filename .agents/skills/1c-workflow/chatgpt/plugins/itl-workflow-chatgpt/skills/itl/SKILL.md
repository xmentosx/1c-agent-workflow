---
name: itl
description: "ChatGPT/RDC thin wrapper for the installed project's local itl skill."
---
...
2. Read `<PROJECT_ROOT>\.agents\skills\itl\SKILL.md`; that local file is authoritative.
