---
name: itl-result
description: "ChatGPT/RDC thin wrapper for the installed project's local itl-result skill."
---
...
2. Read `<PROJECT_ROOT>\.agents\skills\itl-result\SKILL.md`; that local file is authoritative.
