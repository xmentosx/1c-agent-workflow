---
name: itl-fork-branch
description: "ChatGPT/RDC thin wrapper for the installed project's local itl-fork-branch skill."
---
...
2. Read `<PROJECT_ROOT>\.agents\skills\itl-fork-branch\SKILL.md`; that local file is authoritative.
