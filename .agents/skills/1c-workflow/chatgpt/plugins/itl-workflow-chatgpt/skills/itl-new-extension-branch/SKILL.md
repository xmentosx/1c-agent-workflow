---
name: itl-new-extension-branch
description: "ChatGPT/RDC thin wrapper for the installed project's local itl-new-extension-branch skill."
---
...
2. Read `<PROJECT_ROOT>\.agents\skills\itl-new-extension-branch\SKILL.md`; that local file is authoritative.
