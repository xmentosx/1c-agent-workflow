...
$env:ITL_TEST_EXECUTION_GUARD_FALLBACK_ROOT = Join-Path $fixtureRuntimeRoot "execution-guards-v2"
...
try {
    ...
    [Environment]::SetEnvironmentVariable("ITL_TEST_EXECUTION_GUARD_FALLBACK_ROOT", $null, "Process")
