---
name: itl-sync-branches
description: "ChatGPT/RDC thin wrapper for the installed project's local itl-sync-branches skill."
---
...
2. Read `<PROJECT_ROOT>\.agents\skills\itl-sync-branches\SKILL.md`; that local file is authoritative.
