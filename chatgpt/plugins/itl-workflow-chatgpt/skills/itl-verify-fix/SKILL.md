---
name: itl-verify-fix
description: "ChatGPT/RDC thin wrapper for the installed project's local itl-verify-fix skill."
---
...
2. Read `<PROJECT_ROOT>\.agents\skills\itl-verify-fix\SKILL.md`; that local file is authoritative.
