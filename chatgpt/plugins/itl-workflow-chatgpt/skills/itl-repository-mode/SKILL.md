---
name: itl-repository-mode
description: "ChatGPT/RDC thin wrapper for the installed project's local itl-repository-mode skill."
---
...
2. Read `<PROJECT_ROOT>\.agents\skills\itl-repository-mode\SKILL.md`; that local file is authoritative.
