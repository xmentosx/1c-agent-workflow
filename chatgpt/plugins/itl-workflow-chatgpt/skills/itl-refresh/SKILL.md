---
name: itl-refresh
description: "ChatGPT/RDC thin wrapper for the installed project's local itl-refresh skill."
---
...
2. Read `<PROJECT_ROOT>\.agents\skills\itl-refresh\SKILL.md`; that local file is authoritative.
