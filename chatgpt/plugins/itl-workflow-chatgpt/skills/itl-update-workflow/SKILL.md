---
name: itl-update-workflow
description: "ChatGPT/RDC thin wrapper for the installed project's local itl-update-workflow skill."
---
...
2. Read `<PROJECT_ROOT>\.agents\skills\itl-update-workflow\SKILL.md`; that local file is authoritative.
