---
name: itl-refresh-lite
description: "ChatGPT/RDC thin wrapper for the installed project's local itl-refresh-lite skill."
---
...
2. Read `<PROJECT_ROOT>\.agents\skills\itl-refresh-lite\SKILL.md`; that local file is authoritative.
