---
name: itl-lock-objects
description: "ChatGPT/RDC thin wrapper for the installed project's local itl-lock-objects skill."
---
...
2. Read `<PROJECT_ROOT>\.agents\skills\itl-lock-objects\SKILL.md`; that local file is authoritative.
