...
Confirm the developer has tested the current work and the Git tree is clean, then refresh master, merge master into the development branch, load only changed files into the development branch infobase, export final CF, mark the branch closed, and switch back to master.
