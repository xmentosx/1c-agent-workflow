---
description: Fast close the current 1C development branch and export final CF
agent: code
---
...
Do not ask for a development branch name. The helper infers it from the current `itldev/<name>` Git branch, refreshes from master, loads changed files, exports final CF, marks the branch closed, and switches back to master.
